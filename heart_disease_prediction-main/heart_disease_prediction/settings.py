...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'youremail@gmail.com'  # Your email account
EMAIL_HOST_PASSWORD = 'yourpassword'  # Your email password (or use an app password by going to managegoogle account by typing app password)
